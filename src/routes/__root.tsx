  ...
  head: () => ({
    meta: [
      ...
      { title: "IAMD — Indian Association of Muscular Dystrophy" },
      {
        name: "description",
        content:
          "Rehabilitation, hydrotherapy and family support for muscular dystrophy at IMDRC Solan, Himachal Pradesh. Empowering lives since 1992.",
      },
      { name: "author", content: "Indian Association of Muscular Dystrophy" },
      { property: "og:title", content: "IAMD — Indian Association of Muscular Dystrophy" },
      {
        property: "og:description",
        content:
          "Integrated muscular dystrophy rehabilitation at IMDRC Solan. Book a visit or donate with 80G tax exemption.",
      },
